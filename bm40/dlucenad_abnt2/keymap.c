...
[_QWERTY] = LAYOUT_planck_mit(
    ...
    LCTL_T(KC_MINS), KC_LGUI, KC_LALT,   SYM, MYNAV,      KC_SPC,    MYNUM, RALT_T(KC_LEFT),    FUN,   KC_UP, RCTL_T(KC_RGHT)
),

//navigation and utility layer ok
[_NAV] = LAYOUT_planck_mit(
     KC_ESC,   KC_F1,   KC_F2,   KC_F3,   KC_F4, _______, _______, KC_HOME,   KC_UP,  KC_END, KC_PGUP, KC_VOLU,
    _______,   KC_F5, _______, _______, _______, _______,  KC_ENT, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_VOLD,
    _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, KC_BSPC,  KC_DEL, _______, _______, KC_MUTE,
